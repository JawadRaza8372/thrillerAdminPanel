    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Home Work</h6>
        ...
        >
          ...
          <div>
            ...
            >
              <div style="margin-bottom: 5px">
                <base-button icon type="primary" @click="AddModal()">
                  ...
                  ></span>
                  <span class="btn-inner--text">Add Home Work</span>
                </base-button>
            ...
            >
              ...
              <el-table-column label="Section"> </el-table-column>
              <el-table-column label="Subject"> </el-table-column>
...
export default {
  ...
  methods: {
    Validate() {
      if (this.myObj.status === null || this.myObj.status.length === 0) {
        this.nameError = "Enter status";
      } else {
        //Save to DB
            ...
            .then((response) => {
              if (response.data.status === "error") {
                ...
                this.$notify({
                  ...
                  horizontalAlign: "center",
                  message:
                    'Saved! <br />Status "' + this.myObj.status + '" updated.',
                  type: "success",
                  icon: "fa fa-check",
            ...
            .then((response) => {
              if (response.data.status === "error") {
                ...
                this.$notify({
                  ...
                  horizontalAlign: "center",
                  message:
                    'Saved! <br />Status "' + this.myObj.status + '" added.',
                  type: "success",
                  icon: "fa fa-check",
                  timeout: this.$store.state.timeout,
                });
    ...
    handleDelete(index, row) {
      swal({
        title: "Are you sure?",
        text: "You want to delete status " + row.status + "?",
        type: "warning",
            ...
            .then((response) => {
              if (response.data.status === "error") {
                ...
                this.$notify({
                  verticalAlign: "bottom",
                  horizontalAlign: "center",
                  message: 'Saved! <br />Status "' + row.status + '" removed.',
                  type: "danger",
                  icon: "fa fa-check",
                  timeout: this.$store.state.timeout,
                });
