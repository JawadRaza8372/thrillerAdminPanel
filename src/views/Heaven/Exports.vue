    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Export Sheets</h6>
            ...
            <form role="form">
              ...
              <div>
                <downloadexcel
                  ...
                  class="text-center"
                >
                  <base-button class="mt-3 col" type="primary">
...
export default {
  ...
  data() {
    return {
      ...
      dates: {
        range: this.currentDate + "to" + this.currentDate,
      },
      isLoading: false,
      myObj: {},
      myCostObj: {},
  ...
  methods: {
    ...
    async fetchTodos() {
      ...
      if (
        this.dates.range == "undefinedtoundefined" ||
        this.dates.range == "" ||
        ...
        this.$notify({
          ...
          message: "Please select type and date range <br />",
          type: "danger",
          icon: "fa fa-ban",
          timeout: 0,
        });
        ...
        this.isLoading = true;
        console.log(this.collectionData);
        var splitedDate = this.dates.range.split(" ");
        this.splitDate.from = splitedDate[0];
        this.splitDate.to = splitedDate[2];
        console.log(this.splitDate);
        const response = await axios.post(
          "https://api.thrillerme.com/export/" + this.collectionData,
          this.splitDate
        );
        if (response.status == 200) {
          this.sign = "fas fa-download";
          this.isLoading = false;
          this.modals.showModal = false;
          this.$notify({
            verticalAlign: "bottom",
            horizontalAlign: "center",
            message: "Downloaded! <br />",
            type: "success",
            icon: "fa fa-check",
    ...
    ExportData() {
      ...
      var url = "https://api.thrillerme.com/export/" + this.collectionData;

      axios
        .post(url, this.splitDate)
        .then((response) => {
