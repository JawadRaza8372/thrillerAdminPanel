    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Session</h6>
            ...
            >
              <div style="margin-bottom: 5px">
                <base-button icon type="primary" @click="AddModal()">
                  ...
                  ></span>
                  <span class="btn-inner--text">Add new session</span>
                </base-button>
...
export default {
  ...
  methods: {
    Validate() {
      if (this.myObj.session.length === 0) {
        this.nameError = "Enter session";
      } else {
        //Save to DB
    ...
    editRecord(index, row) {
      ...
      this.myObj.session = row.session;
    ...
    handleDelete(index, row) {
      swal({
        title: "Are you sure?",
        text: "You want to delete Session " + row.session + "?",
        type: "warning",
            ...
            .then((response) => {
              if (response.data.status === "error") {
                ...
                this.$notify({
                  ...
                  horizontalAlign: "center",
                  message:
                    'Saved! <br />Session "' + row.session + '" removed.',
                  type: "danger",
                  icon: "fa fa-check",
                  timeout: this.$store.state.timeout,
                });
