    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Nationality</h6>
            ...
            >
              <div style="margin-bottom: 5px">
                <base-button icon type="primary" @click="AddModal()">
                  ...
                  ></span>
                  <span class="btn-inner--text">Add Nationality</span>
                </base-button>
...
export default {
  ...
  methods: {
    Validate() {
      if (this.myObj.Nationality.length === 0) {
        this.nameError = "Enter Nationality";
      } else {
        //Save to DB
            ...
            .then((response) => {
              if (response.data.status === "error") {
                ...
                this.$notify({
                  ...
                  horizontalAlign: "center",
                  message:
                    'Saved! <br />Nationality "' +
                    this.myObj.Nationality +
                    '" updated.',
                  type: "success",
                  icon: "fa fa-check",
    ...
    editRecord(index, row) {
      ...
      this.myObj.Nationality = row.Nationality;
    ...
    handleDelete(index, row) {
      swal({
        title: "Are you sure?",
        text: "You want to delete Nationality " + row.Nationality + "?",
        type: "warning",
