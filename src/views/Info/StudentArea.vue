    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Student Area</h6>
          ...
          <template>
            <form role="form">
              <base-input
                ...
                name="studentarea"
                type="text"
                placeholder="Enter Student Area"
                v-model="myObj.StudentArea"
            ...
            >
              <div style="margin-bottom: 5px">
                <base-button icon type="primary" @click="AddModal()">
                  ...
                  ></span>
                  <span class="btn-inner--text">Add Student Area </span>
                </base-button>
...
export default {
  ...
  methods: {
    Validate() {
      if (this.myObj.StudentArea.length === 0) {
        this.nameError = "Enter Student Area";
      } else {
        //Save to DB
            ...
            .then((response) => {
              if (response.data.status === "error") {
                ...
                this.$notify({
                  ...
                  horizontalAlign: "center",
                  message:
                    'Saved! <br />Student Area "' +
                    this.myObj.StudentArea +
                    '" updated.',
                  type: "success",
                  icon: "fa fa-check",
    ...
    editRecord(index, row) {
      ...
      this.myObj.StudentArea = row.StudentArea;
    ...
    handleDelete(index, row) {
      swal({
        title: "Are you sure?",
        text: "You want to delete Student Area " + row.StudentArea + "?",
        type: "warning",
