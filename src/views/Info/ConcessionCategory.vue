    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Concession Category</h6>
          ...
          <template>
            <form role="form">
              <base-input
                ...
                name="category"
                type="text"
                placeholder="Enter concession category"
            ...
            >
              <div style="margin-bottom: 5px">
                <base-button icon type="primary" @click="AddModal()">
                  ...
                  ></span>
                  <span class="btn-inner--text">Add concession category</span>
                </base-button>
...
export default {
  ...
  methods: {
    Validate() {
      if (this.myObj.category.length === 0) {
        this.nameError = "Enter concession category";
      } else if (
        this.myObj.discountPercentage == null ||
        this.myObj.discountPercentage.length === 0
      ) {
        this.dscperError = "Enter dicount percentage";
      } else if (this.myObj.discountPercentage > 100) {
        this.dscperError = "Discount(%) cannot be greater than 100";
      } else if (this.myObj.discountPercentage < 0) {
        this.dscperError = "Discount(%) cannot be less than 0";
      } else {
        //Save to DB
        ...
        this.dscperError = false;
      }
    },
    GetError() {
      return this.nameError;
      return this.dscperError;
    ...
    handleDelete(index, row) {
      swal({
        title: "Are you sure?",
        text: "You want to delete concession category " + row.category + "?",
        type: "warning",
