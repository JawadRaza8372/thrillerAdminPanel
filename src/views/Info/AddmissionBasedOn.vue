    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Admission Based On</h6>
          ...
          <template>
            <form role="form">
              <base-input
                ...
                type="text"
                placeholder="Enter Admission Based On"
                v-model="myObj.AdmissionBasedOn"
            ...
            >
              <div style="margin-bottom: 5px">
                <base-button icon type="primary" @click="AddModal()">
                  ...
                  ></span>
                  <span class="btn-inner--text">Add Admission Based On </span>
                </base-button>
...
export default {
  ...
  data() {
    return {
      ...
      propsToSearch: ["AdmissionBasedOn"],
      tableColumns: [
        {
          type: "selection",
        },
        {
          prop: "AdmissionBasedOn",
          label: "Admission Based On",
          minWidth: 885,
          sortable: true,
        },
  ...
  methods: {
    Validate() {
      if (this.myObj.AdmissionBasedOn.length === 0) {
        this.nameError = "Enter Admission Based On";
      } else {
        //Save to DB
            ...
            .then((response) => {
              if (response.data.status === "error") {
                ...
                this.$notify({
                  ...
                  horizontalAlign: "center",
                  message:
                    'Saved! <br />Admission Based On "' +
                    this.myObj.AdmissionBasedOn +
                    '" updated.',
                  type: "success",
                  icon: "fa fa-check",
    ...
    editRecord(index, row) {
      ...
      this.myObj.AdmissionBasedOn = row.AdmissionBasedOn;
    ...
    handleDelete(index, row) {
      swal({
        title: "Are you sure?",
        text:
          "You want to delete admission based on " + row.AdmissionBasedOn + "?",
        type: "warning",
