    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Transporter</h6>
            ...
            >
              <div style="margin-bottom: 5px">
                <base-button icon type="primary" @click="AddModal()">
                  ...
                  ></span>
                  <span class="btn-inner--text">Add new transporter</span>
                </base-button>
...
export default {
  ...
  methods: {
    Validate() {
      if (this.myObj.driverName.length === 0) {
        this.nameError = "Enter driver name";
      } else {
        //Save to DB
            ...
            .then((response) => {
              if (response.data.status === "error") {
                ...
                this.$notify({
                  ...
                  horizontalAlign: "center",
                  message:
                    'Saved! <br />Transporter "' +
                    this.myObj.driverName +
                    '" updated.',
                  type: "success",
                  icon: "fa fa-check",
    ...
    editRecord(index, row) {
      ...
      this.myObj.driverName = row.driverName;
      (this.myObj.vanNumber = row.vanNumber),
        (this.myObj.NIC = row.NIC),
        (this.myObj.phone = row.phone),
        (this.myObj.address = row.address),
        (this.myObj.route = row.route),
    ...
    handleDelete(index, row) {
      swal({
        title: "Are you sure?",
        text: "You want to delete transporter " + row.driverName + "?",
        type: "warning",
