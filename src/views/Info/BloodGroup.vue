    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Blood Group</h6>
            ...
            >
              <div style="margin-bottom: 5px">
                <base-button icon type="primary" @click="AddModal()">
                  ...
                  ></span>
                  <span class="btn-inner--text">Add Blood Group</span>
                </base-button>
...
export default {
  ...
  methods: {
    Validate() {
      if (this.myObj.BloodGroup.length === 0) {
        this.nameError = "Enter Blood Group";
      } else {
        //Save to DB
            ...
            .then((response) => {
              if (response.data.status === "error") {
                ...
                this.$notify({
                  ...
                  horizontalAlign: "center",
                  message:
                    'Saved! <br />Blood Group "' +
                    this.myObj.BloodGroup +
                    '" updated.',
                  type: "success",
                  icon: "fa fa-check",
    ...
    editRecord(index, row) {
      ...
      this.myObj.BloodGroup = row.BloodGroup;
    ...
    handleDelete(index, row) {
      swal({
        title: "Are you sure?",
        text: "You want to delete Blood Group " + row.BloodGroup + "?",
        type: "warning",
